...
namespace Poker_Game {
    public partial class FormPoker : Form {
        ...
        private void initalize() {
            ...
            labelListMoney.Add(lblMoney);
            labelListMoney.Add(lblM2);
            labelListMoney.Add(lblM3);
            labelListMoney.Add(lblM4);
            labelListName.Add(lblName);
            labelListName.Add(lblP2);
            labelListName.Add(lblP3);
            labelListName.Add(lblP4);
            labelListAction.Add(lblAction);
            labelListAction.Add(lblA2);
            labelListAction.Add(lblA3);
            labelListAction.Add(lblA4);
            panelList.Add(panelPlayer);
        ...
        protected override void OnLoad(EventArgs e) {
            ...
            cam.Speech.CurrentLanguage = SupportedLanguage.PtBR;
            cam.Speech.Say("Olá pessoal do TDC");
            cam.Speech.SpeechRecognized += (sender, args) => {
                var text = args.Sentence.ToLower();
                Debug.WriteLine("-> " + text);
                if (text.Contains("tudo")) {
                    cam.Speech.Say("É truco, ladrão!!!");
                    btnAllIn_Click(this, EventArgs.Empty);
                }
            };
